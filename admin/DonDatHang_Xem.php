                            ...
                            <div class="card-body">
                                <form id="frmDuyetDDH" method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
                                    <table class="table table-hover">
                                        <tr>
                                            <td>
                                                <b>Mã đơn:</b> <?php echo $cotDDH["MaDonDat"]; ?> <br>
                                                <b>Người nhận:</b> <?php echo $cotDDH["hotentv"]; ?> <br>
                                                <b>Địa chỉ:</b> <?php echo $cotDDH["NoiGiao"]; ?> <br>
                                            ...
                                            Trạng thái:
                                                <select name="TrangThai" id="TrangThai" class="form-control">
                                                    <?php if(trim($cotDDH["TrangThai"])==0) {?>
                                                        <option class='text-danger' selected value="0">Chưa giao hàng (Chắc nhân viên lười)</option>
                                                        <option class='text-success' value="1">Đã giao hàng rồi nha</option>
                                                    <?php }else{
                                                        ?>
                                                        <option class='text-danger' value="0">Chưa giao hàng (Chắc nhân viên lười)</option>
                                                        <option class='text-success' style="color:green;" selected value="1">Đã giao hàng rồi nha</option>
                                                <?php } ?>
                                                </select>
                                                
                                                <br>
                                                <a href="<?php echo $_SERVER["PHP_SELF"]; ?>?MaDonDatXoa=<?php echo $cotDDH["MaDonDat"]; ?>" id="Xoa" class="btn btn-outline-danger">Xóa</a>
                                            </td>
                                        ...
                                        <tr class="card bg-info text-white">
                                            <th class="card-body" colspan="3">Tổng tiền</th>
                                            <th class="card-body"><?php echo DinhDangTien($tongtien); ?> VNĐ</th>
                                        </tr>
