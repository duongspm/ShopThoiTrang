...
<?php
    ...
    if(isset($_GET["loaisp"])) {
        ...
        $laysp = phan_trang("*", "sanpham", "where MaLoai='" . $dieukientrang . "'", 6, $trang, "&loaisp=" . $dieukientrang);
    }
    else {
        $dieukientrang = $_GET["gia"];
        $laysp = phan_trang("*", "sanpham", "where GiaSP < '" . $dieukientrang . "'", 6, $trang, "&gia=" . $dieukientrang);
    }
...
<html lang="en">
<head>
    <title>Product | Loại Sản Phẩm</title>
</head>
<body>
    ...
    <div class="products">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="products.php" role="tab"
